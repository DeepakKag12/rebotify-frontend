    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        >
          ...
          <p className="text-gray-600">Manage your recycling operations and track your impact.</p>
        </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <button className="p-4 border-2 border-dashed border-brand-green rounded-lg hover:bg-brand-green/5 transition-colors text-left">
              ...
              <p className="text-sm text-gray-500 mt-1">Find e-waste to recycle</p>
            </button>
            <button className="p-4 border-2 border-dashed border-gray-300 rounded-lg hover:bg-gray-50 transition-colors text-left">
              ...
              <p className="text-sm text-gray-500 mt-1">Place bids on available items</p>
            </button>
            <button className="p-4 border-2 border-dashed border-gray-300 rounded-lg hover:bg-gray-50 transition-colors text-left">
              <p className="font-medium text-gray-900">View Certificates</p>
              <p className="text-sm text-gray-500 mt-1">Access your certifications</p>
            </button>
          </div>
        </motion.div>
