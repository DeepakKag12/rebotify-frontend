    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        >
          ...
          <p className="text-gray-600">Here's what's happening with your e-waste management today.</p>
        </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <button className="p-4 border-2 border-dashed border-brand-green rounded-lg hover:bg-brand-green/5 transition-colors text-left">
              ...
              <p className="text-sm text-gray-500 mt-1">Post your e-waste for recycling</p>
            </button>
            <button className="p-4 border-2 border-dashed border-gray-300 rounded-lg hover:bg-gray-50 transition-colors text-left">
              ...
              <p className="text-sm text-gray-500 mt-1">Find certified recyclers nearby</p>
            </button>
            <button className="p-4 border-2 border-dashed border-gray-300 rounded-lg hover:bg-gray-50 transition-colors text-left">
              <p className="font-medium text-gray-900">Track Deliveries</p>
              <p className="text-sm text-gray-500 mt-1">Monitor your e-waste pickups</p>
            </button>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="text-center py-12">
            ...
            <p className="text-sm text-gray-400 mt-2">Start by creating your first listing!</p>
          </div>
        </motion.div>
      </div>
    </div>
