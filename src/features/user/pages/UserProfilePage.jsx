  ...
  const stats = [
    {
      icon: ShoppingBag,
      label: "Total Sales",
      value: transactionsData?.sales?.length || 0,
      color: "bg-blue-500",
    },
    {
      icon: DollarSign,
          ...
          <div className="p-6">
            ...
            {activeTab === "sales" && (
              ...
              >
                {isLoading ? (
                  ...
                  transactionsData.sales.length > 0 ? (
                  transactionsData.sales.map((transaction) => (
                    <div
                      key={transaction._id}
            ...
            {activeTab === "deliveries" && (
              ...
              >
                {deliveriesLoading ? (
                ...
                ) : deliveriesData?.sales && deliveriesData.sales.length > 0 ? (
                  deliveriesData.sales.map((delivery) => (
                    <div
                      key={delivery._id}
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-600">
                      Your deliveries will appear here once you sell an item
                    </p>
                  </div>
                )}
              </motion.div>
